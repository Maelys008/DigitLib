...
class LibraryAndBookSeeder extends Seeder
{
    public function run(): void
    {
        ...
        DB::table('copies')->insert([
            ['book_id' => $bookA, 'codeQR' => 'QR-LIB1-A-001', 'condition' => 'new',  'status' => 'available', 'date_added' => now(), 'created_at' => now(), 'updated_at' => now()],
            ['book_id' => $bookA, 'codeQR' => 'QR-LIB1-A-002', 'condition' => 'good', 'status' => 'available', 'date_added' => now(), 'created_at' => now(), 'updated_at' => now()],
        ]);
        ...
        DB::table('copies')->insert([
            ['book_id' => $bookB, 'codeQR' => 'QR-LIB1-B-001', 'condition' => 'new', 'status' => 'available', 'date_added' => now(), 'created_at' => now(), 'updated_at' => now()],
        ]);
        ...
        $copyC1 = DB::table('copies')->insertGetId(['book_id' => $bookC, 'codeQR' => 'QR-LIB1-C-001', 'condition' => 'new',  'status' => 'borrowed',  'date_added' => now(), 'created_at' => now(), 'updated_at' => now()]);
        DB::table('copies')->insert([
            ['book_id' => $bookC, 'codeQR' => 'QR-LIB1-C-002', 'condition' => 'good', 'status' => 'available', 'date_added' => now(), 'created_at' => now(), 'updated_at' => now()],
            ['book_id' => $bookC, 'codeQR' => 'QR-LIB1-C-003', 'condition' => 'new',  'status' => 'available', 'date_added' => now(), 'created_at' => now(), 'updated_at' => now()],
        ]);
        ...
        DB::table('copies')->insert([
            ['book_id' => $bookD, 'codeQR' => 'QR-LIB1-D-001', 'condition' => 'good', 'status' => 'available', 'date_added' => now(), 'created_at' => now(), 'updated_at' => now()],
            ['book_id' => $bookD, 'codeQR' => 'QR-LIB1-D-002', 'condition' => 'good', 'status' => 'available', 'date_added' => now(), 'created_at' => now(), 'updated_at' => now()],
        ]);
        ...
        DB::table('copies')->insert([
            ['book_id' => $bookE, 'codeQR' => 'QR-LIB2-E-001', 'condition' => 'new',  'status' => 'available', 'date_added' => now(), 'created_at' => now(), 'updated_at' => now()],
            ['book_id' => $bookE, 'codeQR' => 'QR-LIB2-E-002', 'condition' => 'good', 'status' => 'available', 'date_added' => now(), 'created_at' => now(), 'updated_at' => now()],
        ]);
        ...
        DB::table('copies')->insert([
            ['book_id' => $bookF, 'codeQR' => 'QR-LIB2-F-001', 'condition' => 'new', 'status' => 'available', 'date_added' => now(), 'created_at' => now(), 'updated_at' => now()],
        ]);
        ...
        DB::table('copies')->where('id', $copyB1)->update(['status' => 'borrowed']);
