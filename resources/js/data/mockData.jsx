...
},
{
  ...
  note: 4.5,
  genre: "Mystère",
  description: "Le célèbre détective Hercule Poirot se trouve à bord de l'Orient-Express, bloqué par la neige. Un meurtre a été commis, et le train est coupé du monde. Poirot doit résoudre l'énigme avant que le meurtrier ne s'échappe. Chaque passager a un mobile, mais qui est le coupable ?",
  annee_publication: 1934,
  isbn: "978-2-702-14250-3",
  image_couverture: "https://images.unsplash.com/photo-1500757810556-5d600d9b737d?w=400&h=600&fit=crop",
  nb_exemplaires: 5,
  nb_disponibles: 3,
  bibliotheque_id: 1,
  bibliotheque: bibliotheques[0],
  mots_cles: ["Mystère", "Enquête", "Poirot", "Train"]
},
{
  id: 101,
  titre: "Ça",
  ...
  note: 4.6,
  genre: "Horreur",
  description: "Dans la petite ville de Derry, des enfants disparaissent. Un groupe d'adolescents, surnommés le Club des Ratés, découvre que la terreur vient d'une entité maléfique qui prend la forme d'un clown nommé Ça. Vingt-sept ans plus tard, ils doivent revenir affronter leur pire cauchemar.",
  annee_publication: 1986,
  isbn: "978-2-266-14352-3",
  image_couverture: "https://images.unsplash.com/photo-1509248961158-e54f6934749c?w=400&h=600&fit=crop",
  nb_exemplaires: 4,
  nb_disponibles: 2,
  bibliotheque_id: 2,
  bibliotheque: bibliotheques[1],
  mots_cles: ["Clown", "Peur", "Enfance", "Cauchemar"]
},
{
  id: 102,
  ...
  note: 4.4,
  genre: "Voyage",
  description: "Phileas Fogg, un gentleman anglais, parie qu'il peut faire le tour du monde en quatre-vingts jours. Accompagné de son fidèle valet Passepartout, il entreprend un voyage extraordinaire à travers les continents, vivant d'innombrables aventures et défis.",
  annee_publication: 1872,
  isbn: "978-2-070-36827-7",
  image_couverture: "https://images.unsplash.com/photo-1488646953014-85cb44e25828?w=400&h=600&fit=crop",
  nb_exemplaires: 6,
  nb_disponibles: 4,
  bibliotheque_id: 3,
  bibliotheque: bibliotheques[2],
  mots_cles: ["Voyage", "Aventure", "Tour du monde", "Paris"]
},
{
  id: 103,
  titre: "Clean Code",
  ...
  note: 4.9,
  genre: "Programmation",
  description: "Un guide essentiel pour tout développeur souhaitant écrire du code propre, maintenable et efficace. Robert C. Martin partage les principes et les meilleures pratiques pour produire un code de qualité. Le livre aborde la gestion des noms, les fonctions, les commentaires, le formatage, et bien plus encore.",
  annee_publication: 2008,
  isbn: "978-0-132-35088-4",
  image_couverture: "https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=400&h=600&fit=crop",
  nb_exemplaires: 8,
  nb_disponibles: 5,
  bibliotheque_id: 1,
  bibliotheque: bibliotheques[0],
  mots_cles: ["Programmation", "Code", "Développement", "Best practices"]
},
{
  id: 104,
  titre: "Dune",
  ...
  note: 4.8,
  genre: "Science-Fiction",
  description: "Sur la planète désertique Arrakis, la seule source de l'épice la plus précieuse de l'univers, les intrigues politiques et religieuses se mêlent. Paul Atréides, héritier d'une grande maison, doit naviguer entre trahisons et prophéties pour sauver sa famille et l'humanité.",
  annee_publication: 1965,
  isbn: "978-2-266-21092-8",
  image_couverture: "https://images.unsplash.com/photo-1534447677768-be436bb09401?w=400&h=600&fit=crop",
  nb_exemplaires: 7,
  nb_disponibles: 3,
  bibliotheque_id: 2,
  bibliotheque: bibliotheques[1],
  mots_cles: ["Science-fiction", "Espace", "Politique", "Épice"]
},
{
  id: 200,
  ...
  note: 4.7,
  genre: "Classique",
  description: "Le jeune d'Artagnan quitte sa Gascogne natale pour rejoindre Paris et devenir mousquetaire. Il se lie d'amitié avec Athos, Porthos et Aramis, trois mousquetaires du roi. Ensemble, ils vont affronter les intrigues du cardinal de Richelieu et de la mystérieuse Milady. Une aventure épique pleine de duels, de trahisons et d'honneur.",
  ...
  bibliotheque_id: 1,
  bibliotheque: bibliotheques[0],
  mots_cles: ["Aventure", "Mousquetaires", "France", "Duel"]
},
{
  id: 201,
  ...
  note: 4.9,
  genre: "Fantasy",
  description: "Dans un monde médiéval fantastique, un jeune hobbit nommé Frodon Sacquet hérite d'un anneau maléfique. Pour sauver la Terre du Milieu, il doit entreprendre un périlleux voyage pour détruire l'anneau dans les flammes de la Montagne du Destin. Accompagné de compagnons fidèles, il affrontera des créatures terrifiantes et des forces obscures.",
  annee_publication: 1954,
  isbn: "978-2-266-19720-5",
  image_couverture: "https://images.unsplash.com/photo-1462759353907-b2ea5ebd72e7?w=400&h=600&fit=crop",
  nb_exemplaires: 8,
  nb_disponibles: 4,
  bibliotheque_id: 2,
  bibliotheque: bibliotheques[1],
  mots_cles: ["Fantasy", "Anneau", "Hobbit", "Aventure"]
},
{
  id: 202,
  ...
  note: 4.5,
  genre: "Poésie",
  description: "Recueil majeur de la poésie française, Les Fleurs du Mal explore les thèmes de la beauté, de la mort, de l'amour et de l'angoisse existentielle. Baudelaire y exprime sa vision du monde entre spleen et idéal, dans un style novateur qui a marqué la littérature. Condamné pour immoralité à sa sortie, l'œuvre est aujourd'hui considérée comme un chef-d'œuvre.",
  annee_publication: 1857,
  isbn: "978-2-070-41345-8",
  image_couverture: "https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=400&h=600&fit=crop",
  nb_exemplaires: 5,
  nb_disponibles: 3,
  bibliotheque_id: 3,
  bibliotheque: bibliotheques[2],
  mots_cles: ["Poésie", "Baudelaire", "Spleen", "Idéal"]
},
{
  id: 203,
  titre: "Le Guide Culinaire",
  auteur: "Auguste Escoffier",
  note: 4.6,
  genre: "Cuisine",
  description: "Le livre de référence de la cuisine française moderne. Auguste Escoffier, le chef des chefs, y présente plus de 5000 recettes classiques et techniques culinaires. Cet ouvrage a révolutionné la gastronomie et reste une bible pour les cuisiniers professionnels et amateurs éclairés.",
  annee_publication: 1903,
  isbn: "978-2-081-22487-8",
  image_couverture: "https://images.unsplash.com/photo-1556911261-6bd341186b2f?w=400&h=600&fit=crop",
  nb_exemplaires: 4,
  nb_disponibles: 2,
  bibliotheque_id: 1,
  bibliotheque: bibliotheques[0],
  mots_cles: ["Cuisine", "Gastronomie", "Recettes", "France"]
},
{
  id: 204,
  ...
  note: 4.8,
  genre: "Art",
  description: "Une introduction accessible et passionnante à l'histoire de l'art occidental, de la préhistoire à nos jours. Gombrich raconte l'évolution des styles et des techniques à travers les siècles. Ce livre est devenu un classique pour tous ceux qui souhaitent comprendre et apprécier l'art.",
  annee_publication: 1950,
  isbn: "978-2-081-22488-5",
  image_couverture: "https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?w=400&h=600&fit=crop",
  nb_exemplaires: 6,
  nb_disponibles: 4,
  bibliotheque_id: 2,
  bibliotheque: bibliotheques[1],
  mots_cles: ["Art", "Peinture", "Sculpture", "Histoire"]
},
{
  id: 205,
  ...
  note: 4.7,
  genre: "Thriller",
  description: "Mikael Blomkvist, journaliste d'investigation, est chargé de résoudre une disparition vieille de quarante ans. Il s'associe à Lisbeth Salander, une hackeuse au passé trouble. Ensemble, ils plongent dans les secrets sombres d'une riche famille suédoise. Un thriller haletant qui a conquis le monde entier.",
  ...
  bibliotheque_id: 3,
  bibliotheque: bibliotheques[2],
  mots_cles: ["Thriller", "Enquête", "Suspense", "Suède"]
},
{
  id: 206,
  ...
  description: "Un guide pratique pour transformer sa vie. Tony Robbins partage ses techniques de programmation neuro-linguistique pour surmonter ses peurs, développer sa confiance et atteindre ses objectifs. Des exercices concrets pour changer ses habitudes et libérer son potentiel.",
  annee_publication: 1987,
  isbn: "978-2-266-24578-4",
  image_couverture: "https://images.unsplash.com/photo-1474418397713-7ede21d49118?w=400&h=600&fit=crop",
  nb_exemplaires: 8,
  nb_disponibles: 5,
  bibliotheque_id: 1,
  bibliotheque: bibliotheques[0],
  mots_cles: ["Développement personnel", "PNL", "Confiance", "Objectifs"]
}
];
