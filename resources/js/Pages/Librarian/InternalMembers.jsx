...
export default function InternalMembers() {
 ...
 // Liste des rôles selon la  base de donées
const roles = [
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        <div className="bg-white border-b border-gray-200 px-6 py-4">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-2">Membres internes</h1>
        </div>
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4 sticky top-0 z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Membres internes</h1>
      ...
      <div className="p-6">
            ...
            <div key={member.id} className="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
              <div className="flex items-center justify-between">
                ...
                {member.user_id !== user?.id && (
                  ...
                  >
										<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6" className="w-5 h-5">
        ...
        {members.length === 0 && (
          <div className="text-center py-12 bg-white rounded-xl">
            ...
            <p className="text-gray-500">Aucun membre interne</p>
            <button onClick={() => setShowAddModal(true)} className="mt-3 text-purple-600 text-sm">
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white rounded-t-3xl z-50 animate-slide-up max-h-[85vh] overflow-y-auto">
            ...
            <form onSubmit={handleAddMember} className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">L'utilisateur doit déjà avoir un compte DigiLib</p>
              </div>
              ...
              <button
                ...
                className="w-full bg-purple-600 text-white font-semibold py-4 rounded-xl hover:bg-purple-700 disabled:bg-gray-400 transition-colors"
              >
