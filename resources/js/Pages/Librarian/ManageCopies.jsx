...
export default function ManageCopies() {
  ...
  const getConditionBadge = (condition) => {
    switch (condition) {
      case 'neuf': return <span className="px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-400 rounded-full text-xs">Neuf</span>;
      case 'bon': return <span className="px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 rounded-full text-xs">Bon</span>;
      case 'abîmé': return <span className="px-2 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-800 dark:text-orange-400 rounded-full text-xs">Abîmé</span>;
      case 'très abîmé': return <span className="px-2 py-1 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-400 rounded-full text-xs">Très abîmé</span>;
      default: return <span className="px-2 py-1 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 rounded-full text-xs">{condition}</span>;
    }
  };
