...
import { ArrowLeft, Moon, Globe, Bell, ChevronRight, Building, LogOut, Users } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchUserLibraries = async () => {
      ...
      try {
        ...
        // 2. Bibliothèques où il est membre interne (staff)
        const internal = allLibraries.filter(lib => {
          // Ce n'est pas sa bibliothèque
          if (lib.administrator_id === user?.id) return false;
          // C'est une bibliothèque où il est membre interne
        ...
        <div className="space-y-6">
          ...
          <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
            ...
            {isLoading ? (
              ...
              <>
                {/* 1. BOUTON POUR LE PROPRIÉTAIRE (ADMIN) */}
                {ownedLibrary && (
