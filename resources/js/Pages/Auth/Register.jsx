    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 flex flex-col">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 pb-20">
        ...
        <div className="flex justify-between gap-3 mb-8">
          <button className="flex-1 h-14 bg-[#F5F5F5] dark:bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
            <span className="text-2xl font-bold text-blue-600">f</span>
          </button>
          
          <button className="flex-1 h-14 bg-[#F5F5F5] dark:bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
            <span className="text-2xl font-bold text-gray-800 dark:text-white">G</span>
          </button>
          
          <button className="flex-1 h-14 bg-[#F5F5F5] dark:bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors">
            <svg className="w-6 h-6 fill-current text-gray-800 dark:text-white" viewBox="0 0 384 512">
