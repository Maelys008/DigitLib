        ...
        <div className="bg-white border-b border-gray-100 sticky top-0 z-10">
          <div className="px-6 py-4">
            <div className="flex items-center gap-4 mb-4">
              ...
              <h1 className="text-xl font-bold text-gray-900">Toutes les bibliothèques</h1>
            </div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-gray-100 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          {isLoading ? (
            ...
            <div className="text-center py-12 bg-white rounded-xl">
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Aucune bibliothèque trouvée</h3>
