  ...
  useEffect(() => {
    const fetchReturnedLoans = async () => {
      ...
      try {
        ...
        // Extraire les livres avec la date de retour
      ...
      <div className="px-6 py-4">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Déjà lus</h1>
          </div>
        </div>
        ...
        {readBooks.length > 0 ? (
          ...
          <div className="text-center py-12 bg-[#F6F6F6] rounded-xl">
            ...
            <p className="text-gray-500 text-sm">Aucun livre déjà lu</p>
