...
export default function Profile() {
  ...
  const menuItems = [
    ...
    { id: 'badge', icon: Award, label: 'Badge', color: 'text-purple-600', bgColor: 'bg-purple-100', onClick: () => setShowBadgeModal(true) },
    ...
    <MobileLayout>	
      <div className="px-6 py-4">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 text-center">{displayName}</h1>
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          <div className="bg-gray-100 rounded-xl p-3 text-center">
            ...
            <p className="font-semibold text-gray-900 text-sm">{profile.badge?.name || 'Débutant'}</p>
          </div>
          ...
          <div className="bg-gray-100 rounded-xl p-3 text-center">
            ...
            <p className="font-semibold text-gray-900 text-sm">{profile.score || 0}</p>
          </div>
          ...
          <div className="bg-gray-100 rounded-xl p-3 text-center">
            ...
            <p className="font-semibold text-gray-900 text-sm">{stats.total_loans || 0}</p>
          </div>
        </div>
