        ...
        <MobileLayout>
            <div className="px-6 py-4 pb-24">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Créer une étagère</h1>
                </div>
                ...
                <div className="mb-6">
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                    />
                </div>
                ...
                <div className="mb-6">
                    ...
                    <textarea
                        ...
                        rows={4}
                        className="w-full px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent resize-none text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500"
                    />
                </div>
                ...
                <div className="mb-8">
                    ...
                    <div className="space-y-3 max-h-80 overflow-y-auto scrollbar-hide pr-2">
                        {favoris.map((livre) => (
                            <div
                                ...
                                className="flex items-center justify-between p-3 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 cursor-pointer hover:border-purple-200 dark:hover:border-purple-700 transition-colors"
                            >
                    ...
                    <button
                        ...
                        className="flex items-center justify-between w-full mt-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-xl hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                    >
                        <div className="flex items-center gap-2">
                            <Heart className="w-5 h-5 text-pink-600 dark:text-pink-400" />
                            <span className="text-sm font-medium text-gray-900 dark:text-white">Voir tous les favoris</span>
                        </div>
