            ...
            <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
                <div className="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
                    <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between rounded-t-2xl">
                        <h2 className="text-xl font-bold text-gray-900">Ajouter une bibliothèque partenaire</h2>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-4">
                        ...
                        {/* Bibliothèque parente */}
												<div>
														...
														<p className="text-xs text-gray-400 mt-1">La bibliothèque partenaire sera rattachée à cette bibliothèque principale</p>
												</div>
