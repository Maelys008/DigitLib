...
export default function KkiapayPayment({ 
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      // 🔥 REDIRECTION DIRECTE (pas de widget)
        ...
        <div className="p-6">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex-1 px-4 py-3 bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-xl font-medium disabled:opacity-50"
            >
              Annuler
            </button>
            <button
            ...
            >
              {status === 'loading' ? (
                ...
                <>
                  ...
                  Payer {penalty?.amount?.toLocaleString()} FCFA
                </>
              )}
            </button>
          </div>
